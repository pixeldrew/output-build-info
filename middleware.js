...
export const DEFAULT_FILENAME = ".buildinfo.json";

/**
 * Middleware that reads the package.json from the application root then adds name, version and .buildinfo.json content to express app
